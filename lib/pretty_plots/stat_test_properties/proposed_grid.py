...
def create_proposed_parameter_grid():
    ...
    start,end,size,base = -15,1,10,10
    ...
    nframes_ticks = nframes_tickmarks
    ...
    B_ticks = B_tickmarks
    B_tickmarks_str = ["%d" % x for x in pmis_tickmarks]
