...
class TransformerNetwork32_v4(nn.Module):
    ...
    def __init__(self, ftr_model, d_model, im_size, input_patch, output_patch, n_frames, bw=False, denoise_model = None):
        ...
        # self.perform = Performer(d_model,8,4)
    ...
    def forward(self, inputs, outputs):
        ...
        for patch in range(n_patches):
            ...
            attn_patch,_ = self.attn(ifp_enc,ifp_enc,in_patches_flat[patch])
