...
def get_experiment_set_v3(rerun=False):
    version = 'v3'
    ...
    # set exp defaults
    cfg.agg_enc_fxn = 'mean'
    cfg.hyper_params = {'h':0}
    cfg.optim_type = 'lars'
    cfg.lr_bs_scale = 'linear_256'
    

    # determine experiment grid
    # batch_grid = [1536,768,384,256]
    # batch_grid = [516,258,129,86]
    batch_grid = [2*512,2*258,2*129,2*86]
    N_grid = [2,4,8,12]
...
def _exp_from_cfg(_cfg,noise_params,bs,N,epochs):
