...
# -- project imports --
from layers.attn import TransformerNetwork32,TransformerNetwork32_noxform,TransformerNetwork32_v3,TransformerNetwork32_v4
...
def load_model(cfg):
    ...
    elif cfg.model_version == "v4":
        return load_model_v4(cfg)
    else:
