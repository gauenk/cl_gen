"""
Configurations for PIB experiments
...
def get_args():
    parser = argparse.ArgumentParser(description="Run a PIB Experiment")
...
def set_cfg(args):
    ...
    model_path = Path(f"{settings.ROOT_PATH}/output/pib/{dsname}/{cfg.exp_name}/model/")
    optim_path = Path(f"{settings.ROOT_PATH}/output/pib/{dsname}/{cfg.exp_name}/optim/")
