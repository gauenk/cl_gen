...
def set_cfg(args):
    ...
    model_path = Path(f"{settings.ROOT_PATH}/output/n2n/{dsname}/{cfg.exp_name}/model/")
    optim_path = Path(f"{settings.ROOT_PATH}/output/n2n/{dsname}/{cfg.exp_name}/optim/")
