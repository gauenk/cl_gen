...
def get_set8_dataset(cfg):
    ...
    # -- create objcs --
    data = edict()
    data.tr = SET8(iroot,froot,sroot,tr_split,isize,ps,tr_nsamples,nframes,noise_info)
    data.val = SET8(iroot,froot,sroot,"val",isize,ps,val_nsamples,nframes,noise_info)
    data.te = SET8(iroot,froot,sroot,"test",isize,ps,te_nsamples,nframes,noise_info)
