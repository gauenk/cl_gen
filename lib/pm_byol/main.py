...
from .model_io import load_model,load_unet_model,load_model_fp,load_model_kpn,load_burst_n2n_model,load_burst_kpn_model,save_burst_model
...
def run_me(rank=0,Sgrid=[1],Ngrid=[3],nNgrid=1,Ggrid=[25.],nGgrid=1,ngpus=3,idx=0):
    ...
    if cfg.load:
        name = "denoiser"
        fp = "/home/gauenk/Documents/experiments/cl_gen/output/pm-byol/cifar10/default/model/modelBurst/unsup_pm-byol_burstv2_voc_noCascade_b20_n8_f128_filterSized9_noAlignNet_noUnet_unet_mse_noKL/dynamic_wmf/128_1_8/1/blind/8/25.0/denoiser/checkpoint_83.tar"
        ...
        fp = "/home/gauenk/Documents/experiments/cl_gen/output/pm-byol/cifar10/default/optim/modelBurst/unsup_pm-byol_burstv2_voc_noCascade_b20_n8_f128_filterSized9_noAlignNet_noUnet_unet_mse_noKL/dynamic_wmf/128_1_8/1/blind/8/25.0/denoiser/checkpoint_83.tar"
        ...
        cfg.current_epoch = 0
    scheduler = make_lr_scheduler(cfg,optimizer,cfg.global_step)
    ...
    test_before = False
    if test_before:
        ave_psnr,record_test = test_loop(cfg,model,data.te,loader.te,-1,writer)
    ...
    for epoch in range(cfg.current_epoch,cfg.epochs):
        ...
        losses,record_losses = train_loop(cfg,model,optimizer,scheduler,loader.tr,
    ...
    root = Path(f"{settings.ROOT_PATH}/output/pm-byol/{postfix}/")
