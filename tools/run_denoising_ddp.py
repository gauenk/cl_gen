...
from denoising.exp_set_v3 import get_experiment_set_v3
...
def run_experiment_set(version="v1"):
    ...
    if version == "v1":
        ...
        cfgs = get_experiment_set_v3(True)
    else:
...
def run_experiment_serial(cfgs,version,mode,use_ddp=True):
    for cfg in cfgs:
        ...
        if use_ddp:
            ...
            run_serial(cfg=cfg)            
        record_experiment(cfg,f'{version}_{mode}','end',t)
